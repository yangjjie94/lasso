...
![lasso-logo](https://github.com/yangjjie94/lasso/blob/master/assets/lasso-logo.png)

## 项目工程介绍

Lasso是一个基于Python语言开发的项目，它是一个图形化程序，用于从高速摄像得到的分散两相流的图片中识别液滴，包括自动检测液滴轮廓、追踪液滴变形导致的破碎聚并现象并生成分析报告，包括液滴的尺寸分布、破碎后的子液滴分布、聚并的分布。该项目正在开发中，版本v0.1.0，地址请点击[Lasso](https://github.com/yangjjie94/lasso/blob/master/README.md)
...
2018-5-2 17:09:16 README introduction part



## Contributing

The source files from which this book is generated can be found on[GitHub](https://github.com/rust-lang/book/tree/master/first-edition/src).
